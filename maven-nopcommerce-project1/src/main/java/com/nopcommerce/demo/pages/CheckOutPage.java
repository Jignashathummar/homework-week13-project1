...
public class CheckOutPage extends Utility {
    ...
    By getTextsuccessfullMessage = By.xpath("//strong[normalize-space()='Your order has been successfully processed!']");
    ...
    public String getTextsuccessfullMessage() {
        return getTextFromElement(getTextsuccessfullMessage);
    }
}
